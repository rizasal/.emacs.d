...
#+begin_src emacs-lisp :tangle no
  ...
  ;        ;; Core settings
  	    ...
  	    (lsp-format-buffer-on-save-list '(org-mode))
  ;        ;; Modeline settings
  ...
  ;        ;; Semantic settings
  	  ...
  	  (custom-set-faces
  		'(lsp-face-diagnostic-error ((t (:underline (:style line :color "Red1")))))
  		'(lsp-face-diagnostic-warning ((t (:underline (:style line :color "Orange")))))
  		'(lsp-face-diagnostic-info ((t (:underline (:style line :color "DodgerBlue")))))
  		'(lsp-face-diagnostic-hint ((t (:underline (:style line :color "LightGrey"))))))
  	  )
  ...
  (with-eval-after-load 'lsp-mode
    (lsp-register-client
     (make-lsp-client
      ...
      :server-id 'pyrefly
      :priority 1
      :initialization-options '(:settings (:autoImportCompletions t)))))

  (setq lsp-disabled-clients '(pyright pylsp basedpyright ty-ls ruff)) ;; Disable others
  (setq lsp-enabled-clients '(pyrefly))
