...
(use-package dap-mode
  ...
  :hook ((python-mode . dap-mode)
         ...
         (dap-session-created . dap-ui-mode)
         (dap-terminated . dap-ui-mode))
  :config
  ;; Automatically show debug UI when session starts
  (dap-ui-mode 1)
  (dap-tooltip-mode 1)
  (tooltip-mode 1)
  (require 'dap-python)

  ;; Optional: Enable controls in the top bar (if using treemacs)
  ;; (require 'dap-ui)
  ;; (dap-ui-controls-mode 1)

  ;; Set default debugger path (you can override it after uv-activate if needed)
  (setq dap-python-debugger 'debugpy)
  ;; Point to python interpreter; will be overridden by your uv-activate
